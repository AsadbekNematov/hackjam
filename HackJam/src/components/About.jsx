      ...
      <div className="about">
        ...
        <div className="about-content" style={{'margin-bottom': '-1rem'}}>
          ...
          <p className="text-left text-lg">
            Our hackathon is a dynamic platform where brilliant minds come together to transform ideas into reality. 
            ...
            solutions that can change the world. Join us for ***[CHANGE THIS]*** hours of intense coding, collaboration, and innovation as we embrace the motto 'Think. Code. Innovate.' 
